    ...
    <section className="bg-white py-20 sm:py-28">
      <div className="mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
        ...
        <a
          ...
          className="mt-8 inline-flex items-center gap-2 rounded-full bg-primary px-8 py-4 font-semibold text-white shadow-lg ring-2 ring-secondary ring-offset-2 ring-offset-white transition hover:bg-primary-hover"
        >
