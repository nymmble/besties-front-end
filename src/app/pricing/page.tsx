...
export default async function PricingPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-20 sm:px-6 lg:px-8">
      ...
      <div
        className="mt-8 space-y-4 text-stone-600 [&_p]:mb-4 [&_a]:text-amber-600 [&_a]:underline hover:[&_a]:text-amber-700"
      ...
      <Link
        ...
        className="mt-8 inline-block rounded-full bg-amber-500 px-6 py-3 font-semibold text-white transition hover:bg-amber-600"
      >
